...
from management.db import db_set, channel_change_all, channel_get, get_secret_channels
...
class Mailbox:
    ...
    def respond_embed(self, embed: Embed, temporary: bool = False, reactions=None):
        """Send an embed in the channel where a user triggered this function."""
        if reactions is None:
            reactions = []
        self.answer.append(Message(embed, temporary, '', reactions, True))
        return self
