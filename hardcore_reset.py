...
def hard_reset(skip = False):
    ...
    c.execute("CREATE TABLE 'shops' ('item' INTEGER NOT NULL, 'price' REAL NOT NULL, 'bought' INTEGER NOT NULL DEFAULT 0, 'oldprice' REAL NOT NULL DEFAULT 0, PRIMARY KEY('message'));")
