...
def reset(skip = False):
    ...
    c.execute("CREATE TABLE 'game' ('id' INTEGER NOT NULL, 'name' TEXT NOT NULL, 'emoji' TEXT NOT NULL, 'activity' INTEGER NOT NULL DEFAULT 0, 'channel' INTEGER NOT NULL DEFAULT {}, 'role' TEXT NOT NULL DEFAULT 'Spectator', 'fakerole' TEXT NOT NULL DEFAULT 'Spectator', 'uses' INTEGER NOT NULL DEFAULT 0, 'votes' INTEGER NOT NULL DEFAULT 1, 'threatened' INTEGER NOT NULL DEFAULT 0, 'enchanted' INTEGER NOT NULL DEFAULT 0, 'demonized' INTEGER NOT NULL DEFAULT 0, 'powdered' INTEGER NOT NULL DEFAULT 0, 'frozen' INTEGER NOT NULL DEFAULT 0, 'undead' INTEGER NOT NULL DEFAULT 0, 'bites' INTEGER NOT NULL DEFAULT 0, 'bitten' INTEGER NOT NULL DEFAULT 0, 'souls'	INTEGER NOT NULL DEFAULT -1, 'sleepingover' INTEGER NOT NULL DEFAULT 0, 'amulets' TEXT NOT NULL DEFAULT '', 'abducted' INTEGER NOT NULL DEFAULT 0, 'ccs' INTEGER NOT NULL DEFAULT 0, 'horseman' INTEGER NOT NULL DEFAUULT 0, PRIMARY KEY('id','emoji'));".format(config.game_log))
